...
rdata =  np.load('C:/Users/ANIBOH OLAIDE/Documents/UPWORK/4 DRL Encode/Juan/Actor-Critic-Process-control/results/rewards_chiller_seCri.npz')
data1 = rdata['arr_0']
data2 = rdata['arr_1']
print("Rewards are length: {} and {}".format(len(data1), len(data2)))
newdata = np.load('C:/Users/ANIBOH OLAIDE/Documents/UPWORK/4 DRL Encode/Juan/Actor-Critic-Process-control/results/total_rewards_chiller_seCri.npz')
data3 = newdata['arr_0']
print("Total reward length: {}".format(len(data3)))
print(data1)
